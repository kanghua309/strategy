...
def rebalance(context, data):
    ...
    print("===============================================debug print rebalance TODAY:", get_datetime(),
          context.sim_params.end_session - get_datetime())
    ...
    print "To do cvx optimse in our new profolio set ...................",len(xq_new_profolio_dict)
    print xq_new_profolio_dict
...
def get_xq_pos():
    xq_user = easytrader.use('xq')
    xq_user.prepare(user='', account='18618280998', password='Threeeyear3#', portfolio_code='ZH1135253')
    df = pd.DataFrame(xq_user.position)
