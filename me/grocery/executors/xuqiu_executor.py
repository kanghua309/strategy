...
class XieqiuExecutor(Executor):
    def __init__(self,account,password,protfolio):
        Executor.__init__(self,'xq',account,password,[protfolio])
        self.broker = XueqiuLive(user='',account=account, password=password,portfolio_code=protfolio)
